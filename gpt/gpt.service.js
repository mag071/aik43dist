...
let GptService = class GptService {
    ...
    async imageGeneration(imageGenerationDto) {
        return await (0, use_cases_1.imageGenerationUseCase)(this.openai, { ...imageGenerationDto });
    }
    ...
    async geneateImageVariation({ baseImage }) {
        return (0, use_cases_1.imageVariationUseCase)(this.openai, { baseImage });
    }
};
